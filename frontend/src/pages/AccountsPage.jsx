              ...
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  {liLoading ? (
                    ...
                    <p className="mt-0.5 break-all text-sm text-zinc-400">{liAccount.linkedin_email}</p>
                  ) : (
                    <p className="mt-0.5 text-sm text-zinc-500">No account connected</p>
                  )}
                </div>
          ...
          <div className="card relative flex min-w-0 flex-col p-5">
            <div className="flex items-start gap-3 pb-5 pr-28">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  <h3 className="text-lg font-semibold text-zinc-100">Gmail</h3>
                  {gmLoading ? (
                    <p className="mt-0.5 h-4 w-28 animate-pulse rounded bg-surface-700" />
                  ) : gmStatus?.connected ? (
                    <p className="mt-0.5 break-all text-sm text-zinc-400">{gmStatus.account_email}</p>

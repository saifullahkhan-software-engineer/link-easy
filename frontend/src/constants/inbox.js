...
export const INBOX_CHANNELS = [
  ...
  { id: 'instagram', to: '/app/inbox/instagram', label: 'Instagram Chat', platform: 'instagram', accountPath: '/app/account#socials' },
  { id: 'messenger', to: '/app/inbox/messenger', label: 'Messenger Chat', platform: 'facebook', accountPath: '/app/account#socials' },
